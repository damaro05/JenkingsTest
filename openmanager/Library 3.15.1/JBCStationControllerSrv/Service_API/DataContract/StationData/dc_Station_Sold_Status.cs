...
{
    [DataContract()]
    public class dc_Station_Sold_Status
    {
        [DataMember()]
        ...
        [DataMember()]
        public dc_getTemperature TRAFOTemp = new dc_getTemperature(); // soldering stations only
        [DataMember()]
        public dc_getTemperature TempErrorTRAFO = new dc_getTemperature(); // soldering stations only
        [DataMember()]
        public dc_getTemperature TempErrorMOS = new dc_getTemperature(); // soldering stations only
        [DataMember()]
